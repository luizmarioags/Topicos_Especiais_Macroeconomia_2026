...
|---|---|---|
| `A` | tempo | `A20=A19+1` |
| `B` | \(h_t=y_t-y^*_t\) | `B20=C20-D20` |
| `C` | \(y_t=y_{AD,t}-\gamma r^e_t\) | `C20=E20-M20*F20` |
| `D` | \(y^*_t=(1-\eta)y^*_{t-1}+\eta y_{t-1}\) | `D20=(1-S20)*D19+S20*C19` |
| `E` | demanda autônoma | `E20=E19` |
| `F` | \(r^e_t=r_{CB,t}+\phi_\pi(\pi^e_t-\pi_{GOV})\) | `F20=G20+P20*(J20-L20)` |
| `G` | \(r_{CB,t}=r_{CB,t-1}+\phi_y h_{t-1}\) | `G20=G19+Q20*B19` |
| `H` | \(r^*_t=(y_{AD,t}-y^*_t)/\gamma\) | `H20=(E20-D20)/M20` |
| `I` | \(\pi_t=\pi^e_t+\alpha h_t\) | `I20=J20+O20*B20` |
| `J` | \(\pi^e_t=\theta\pi_{t-1}+(1-\theta)\pi^*_t\) | `J20=N20*I19+(1-N20)*K20` |
| `K` | \(\pi^*_t=(1-\chi)\pi_{GOV}+\chi\pi_{t-1}\) | `K20=(1-R20)*L20+R20*I19` |
